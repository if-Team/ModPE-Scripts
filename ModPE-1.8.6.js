...
rideAnimal = function(par1int, par2int){return;};
setNightMode = function(par1boolean){return;};
setPosition = function(par1int, par2double, par3double, par4double){return;};
setPositionRelative = function(par1int, par2double, par3double, par4double){return;};
setRot = function(par1int, par2double, par3double){return;};
setTile = function(par1int, par2int, par3int, par4int, par5int){return;};
setVelX = function(par1int, par2double){return;};
setVelY = function(par1int, par2double){return;};
setVelZ = function(par1int, par2double){return;};
...
ModPE.setCamera = function(par1int){return;};
...
Level.explode = function(par1double, par2double, par3double, par4double){return;};
...
Level.playSoundEnt = function(par1int, par2String, par3double, par4double){return;};
...
Player.getName = function(par1int){return;};
...
Player.isPlayer = function(par1int){return;};
...
Entity.getAnimalAge = function(par1int){return;};
Entity.getEntityTypeId = function(par1int){return;};
Entity.getHealth = function(par1int){return;};
Entity.getMobSkin = function(par1int){return;};
Entity.getNameTag = function(par1int){return;};
Entity.getPitch = function(par1int){return;};
Entity.getRenderType = function(par1int){return;};
Entity.getRider = function(par1int){return;};
Entity.getRiding = function(par1int){return;};
Entity.getUniqueId = function(par1int){return;};
Entity.getVelX = function(par1int){return;};
Entity.getVelY = function(par1int){return;};
Entity.getVelZ = function(par1int){return;};
Entity.getX = function(par1int){return;};
Entity.getY = function(par1int){return;};
Entity.getYaw = function(par1int){return;};
Entity.getZ = function(par1int){return;};
Entity.remove = function(par1int){return;};
Entity.rideAnimal = function(par1int, par2int){return;};
Entity.setAnimalAge = function(par1int, par2int){return;};
Entity.setCape = function(par1int, par2String){return;};
Entity.setCarriedItem = function(par1int, par2int, par3int, par4int){return;};
Entity.setCollisionSize = function(par1int, par2double, par3double){return;};
Entity.setFireTicks = function(par1int, par2int){return;};
Entity.setHealth = function(par1int, par2int){return;};
Entity.setMobSkin = function(par1int, par2String){return;};
Entity.setNameTag = function(par1int, par2String){return;};
Entity.setPosition = function(par1int, par2double, par3double, par4double){return;};
Entity.setPositionRelative = function(par1int, par2double, par3double, par4double){return;};
Entity.setRenderType = function(par1int, par2int){return;};
Entity.setRot = function(par1int, par2double, par3double){return;};
Entity.setSneaking = function(par1int, par2boolean){return;};
Entity.setVelX = function(par1int, par2double){return;};
Entity.setVelY = function(par1int, par2double){return;};
Entity.setVelZ = function(par1int, par2double){return;};
...
Item.setCategory = function(par1int, par2int, par3int){return;};
...
Block.setShape = function(par1int, par2double, par3double, par4double, par5double, par6double, par7double){return;};
