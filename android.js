...
android.content.Context.createPackageContext = function(){};
android.content.Context.getAssets = function(){};
...
android.graphics.drawable.BitmapDrawable.constructor = android.graphics.drawable.Drawable;
android.graphics.drawable.ClipDrawable = function(){};
android.graphics.drawable.ClipDrawable.constructor = android.graphics.drawable.Drawable;
android.graphics.drawable.ColorDrawable = function(){};
android.graphics.drawable.ColorDrawable.constructor = android.graphics.drawable.Drawable;
android.graphics.drawable.Drawable = function(){};
android.graphics.drawable.DrawableContainer = function(){};
android.graphics.drawable.DrawableContainer.constructor = android.graphics.drawable.Drawable;
android.graphics.drawable.GradientDrawable = function(){};
android.graphics.drawable.GradientDrawable.constructor = android.graphics.drawable.Drawable;
android.graphics.drawable.LayerDrawable = function(){};
android.graphics.drawable.LayerDrawable.constructor = android.graphics.drawable.Drawable;
android.graphics.drawable.StateListDrawable = function(){};
android.graphics.drawable.StateListDrawable.constructor = android.graphics.drawable.DrawableContainer;
...
android.graphics.Bitmap.getPixels = function(){};
android.graphics.Bitmap.setPixels = function(){};
...
android.view.View.setId = function(){};
android.view.View.setLayerType = function(){};
...
android.view.ViewGroup.constructor = android.view.View;
...
android.view.ViewGroup.removeAllViews = function(){};
...
android.webkit.WebView.constructor = android.widget.AbsoluteLayout;
android.webkit.WebView.getSettings = function(){};
android.webkit.WebView.loadUrl = function(){};
android.widget = {};
android.widget.AbsoluteLayout = function(){};
android.widget.AbsoluteLayout.constructor = android.view.ViewGroup;
android.widget.Button = function(){};
android.widget.Button.constructor = android.widget.TextView;
android.widget.FrameLayout = function(){};
android.widget.FrameLayout.constructor = android.view.ViewGroup;
android.widget.ImageView = function(){};
android.widget.ImageView.constructor = android.view.View;
...
android.widget.LinearLayout.constructor = android.view.ViewGroup;
...
android.widget.RelativeLayout.constructor = android.view.ViewGroup;
android.widget.ScrollView = function(){};
android.widget.ScrollView.constructor = android.widget.FrameLayout;
android.widget.ScrollView.fullScroll = function(){};
android.widget.TextView = function(){};
android.widget.TextView.constructor = android.view.View;
...
android.widget.TextView.setTransformationMethod = function(){};
...
net.zhuoweizhang.mcpelauncher.ScriptManager.handleMessagePacketCallback = function(){};
